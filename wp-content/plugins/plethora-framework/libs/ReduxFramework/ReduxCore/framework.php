        ...
        class ReduxFramework {
            ...
            public function __construct( $sections = array(), $args = array(), $extra_tabs = array() ) {
                ...
                if ( ! empty( $this->args['opt_name'] ) ) {
                    ...
                    // REMOVED BY PLETHORA ( not working well, does not respect tracking disallowance )        
                    // Tracking // 
                    // $this->_tracking();
                    // PLETHORA---> END
            ...
            public function _options_page_html() {
                ...
                if ( ! empty( $this->args['display_name'] ) ) {
                    ...
                    if ( ! empty( $this->args['display_version'] ) ) {
                        ...
                        // echo '<span>' . $this->args['display_version'] . '</span>'; // ORIGINAL CODE
                        $theme_version = wp_get_theme( $this->args['display_name'] );
                        $theme_version = $theme_version->get( 'Version' );
                        $theme_version = ( $theme_version ) ? "ver." . $theme_version : $this->args['display_version'];
                        echo '<span>' . $theme_version . '</span>';
